...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.CommentInputSchema.createMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).comment.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.CommentInputSchema.deleteMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).comment.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.CommentInputSchema.findFirst).query(({ ctx, input }) => checkRead(db(ctx).comment.findFirst(input as any))),

        findMany: procedure.input($Schema.CommentInputSchema.findMany).query(({ ctx, input }) => checkRead(db(ctx).comment.findMany(input as any))),
